# Generated by Django 2.1.7 on 2019-03-06 12:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bcpp_consent_recapture', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='ClinicSubjectConsent',
            fields=[
                ...
                ('language', models.CharField(choices=[('tn', 'Setswana'), ('en', 'English'), ('kck', 'Ikalanga'), ('hbs', 'Hambukushu')], help_text='The language used for the edc_consent process will also be used during data collection.', max_length=25, verbose_name='Language of consent')),
